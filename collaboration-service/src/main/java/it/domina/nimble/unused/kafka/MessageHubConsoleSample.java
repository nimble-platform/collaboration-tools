 ...
 */
package it.domina.nimble.unused.kafka;
...
import it.domina.nimble.unused.kafka.rest.RESTAdmin;
    ...
    public static void main(String args[])  {
        try {
            ...
            if (isRunningInBluemix) {
                ...
                //logger.log(Level.INFO, JAAS_CONFIG_PROPERTY + ":" + System.getProperty(JAAS_CONFIG_PROPERTY));
