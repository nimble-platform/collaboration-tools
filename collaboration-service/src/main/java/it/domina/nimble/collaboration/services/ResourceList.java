...
@WebServlet(name = "resourceList", description = "Get the resource list of a project", urlPatterns = { "/resourceList" })
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
	        ...
	        if (content.equals("application/json")) {
	            ...
	            Session sess = ServiceConfig.getInstance().getAuth().getPermission(params.getToken(), "resourceList");
	            if (sess!=null) {
	            	ResourceListType lstRes = ServiceConfig.getInstance().readResourceList(params, sess);
