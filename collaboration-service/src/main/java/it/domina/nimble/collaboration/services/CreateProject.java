...
@WebServlet(name = "createProject", description = "Create a new Project", urlPatterns = { "/createProject" })
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
	        ...
	        if (content.equals("application/json")) {
	    		...
	    		Session sess = ServiceConfig.getInstance().getAuth().getPermission(params.getToken(), "createProject");
	    		if (sess != null) {
	    			EProject prj = ServiceConfig.getInstance().getConfig().newProject(params, sess);
		    		logger.log(Level.INFO, "Project " + prj.getID() + " created.");
