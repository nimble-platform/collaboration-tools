...
public class GetResource extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(GetResource.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
	        ...
	        if (content.equals("application/json")) {
	            ...
	            Session sess = ServiceConfig.getInstance().getAuth().getPermission(params.getToken(), "getResource");
	            if (sess!=null) {
	            	ResourceType result = ServiceConfig.getInstance().readResource(params, sess);
